...
// module
exports.push([module.i, ".right-wrapper {\n  background: #3a4144;\n  transition: all 0.4s ease-in-out;\n  position: relative;\n  flex: 1;\n  z-index: 1101;\n  min-height: 922px;\n  border-bottom-left-radius: 3px; }\n  .right-wrapper .set {\n    height: 58px;\n    background: #424b4f;\n    margin-top: 0;\n    margin-bottom: 0;\n    padding: 40px 0;\n    border-bottom: 0;\n    padding-left: 20px;\n    padding-right: 20px; }\n    .right-wrapper .set .set-left {\n      width: 75%;\n      padding-left: 10px;\n      padding-right: 10px; }\n      .right-wrapper .set .set-left .set-head {\n        float: left; }\n        .right-wrapper .set .set-left .set-head .set-excel {\n          font-size: 20px;\n          font-weight: 400;\n          color: #fff; }\n        .right-wrapper .set .set-left .set-head .ui {\n          font-weight: normal;\n          line-height: 1;\n          color: #B3B3B3;\n          font-size: 80%; }\n        .right-wrapper .set .set-left .set-head .use {\n          color: #e6e6e6;\n          margin-top: 4px;\n          margin-bottom: 0;\n          font-size: 14px; }\n          .right-wrapper .set .set-left .set-head .use a {\n            color: #0e90d2; }\n    .right-wrapper .set .set-right {\n      float: right;\n      padding-left: 10px;\n      padding-right: 10px;\n      width: 25%; }\n      .right-wrapper .set .set-right .seting {\n        transition: all 0.4s ease-in-out;\n        opacity: 0.3;\n        float: right;\n        outline: none;\n        border: 1px solid #fff;\n        padding: 16px 36px;\n        font-size: 23px;\n        line-height: 23px;\n        border-radius: 0;\n        padding-top: 14px;\n        color: #fff;\n        background-color: rgba(0, 0, 0, 0);\n        font-weight: 500;\n        vertical-align: middle; }\n        .right-wrapper .set .set-right .seting span {\n          position: fixed;\n          right: 0;\n          top: 75px;\n          color: #969a9b;\n          padding: 2px 12px;\n          background: #141617; }\n        .right-wrapper .set .set-right .seting:hover {\n          background-color: #ffffff;\n          color: #333;\n          opacity: 1; }\n  .right-wrapper .chart-center {\n    padding: 20px; }\n    .right-wrapper .chart-center .widget {\n      width: 100%;\n      min-height: 148px;\n      margin-bottom: 20px;\n      border-radius: 0;\n      position: relative;\n      border: 1px solid #33393c;\n      border-top: 2px solid #313639;\n      background: #4b5357;\n      color: #ffffff; }\n      .right-wrapper .chart-center .widget .widget-head {\n        width: 100%;\n        padding: 15px;\n        border-bottom: 1px solid #3f4649; }\n        .right-wrapper .chart-center .widget .widget-head .widget-title {\n          font-size: 14px;\n          color: #ffffff; }\n\n@media screen and (max-width: 980px) {\n  .right-wrapper {\n    margin-left: 0; }\n  .common {\n    display: none; } }\n\n@media screen and (max-width: 640px) {\n  .right-wrapper {\n    margin-left: 0; }\n  .chart-center {\n    width: 100%; } }\n", ""]);
